		...
		<div class="container box_1170">
                         ...
                         <div class="card col-lg-12" style="padding: 25px;">
                                ...
                                <div class="table-responsive table--no-card m-b-40">
                                     <?php
                                                  $query = "SELECT * FROM police_emergency WHERE state='bihar' ";
                           ...
                           <div class="card col-lg-12"  style="padding: 25px;">
                                ...
                                <div class="table-responsive table--no-card m-b-40">
                                     <?php
                                                  $query = "SELECT * FROM ambulance_emergency WHERE state='bihar' ";
                                                  $query_run = mysqli_query($connection, $query);
                                              ?>
                                    <table class="table table-borderless table-striped table-earning"  >
                                                <thead>
                         ...
                         <div class="card col-lg-12" style="padding: 25px;">
                                ...
                                <div class="table-responsive table--no-card m-b-40">
                                     <?php
                                                  $query = "SELECT * FROM fire_emergency WHERE state='bihar'";
                                                  $query_run = mysqli_query($connection, $query);
                                              ?>
