 ...
 <div class="main-content" >
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                                ...
                                <div class="overview-item overview-item--c5">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px;">Bihar Confirmed Cases</span>
                                ...
                                <div class="overview-item overview-item--recovered">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px;">Bihar Recovered Cases</span>
                                ...
                                <div class="overview-item overview-item--death">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px;">Bihar Death Cases</span>
                                                <h2 id="StateDeath"></h2>
                                            </div>
                                            <div class="progress">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Covid19 Cases In Bihar</h2>
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="au-card au-card-top-countries m-b-40" style="background-color: #ffc107;" >
                               ...
                               <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Covid19 Test Cases In Bihar</h2>
                                <div class="table-responsive table--no-card m-b-40">
                        ...
                        <div class="row">
                               <div class="col-lg-6">
                                     <div class="au-card chart-percent-card" style="height: 600px;">
                                      ...
                                      <div class="au-card chart-percent-card" style="height: 680px;" id="testing">
                                        <div class="au-card-inner">
                                            <h3 class="title-2 tm-b-5">
                                            ...
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-lg-12">
                                                    <iframe src="https://www.google.co.in/maps/d/embed?mid=17umFPzzF4VCfw_W5HUKxeONxYdWqfKfS" width="100%" height="380"></iframe>
                                                </div>
                                            </div>    
                                        </div>    
                                     </div>
...
$.ajax({
    ...
    var conf_rate = (((StateConfirmed)*100)/(4324573));
