...
background-color:#6c5b7b;
    ...
    <!-- header-start -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 register-right " style="background-color: #c06c84;">
                        <ul class="nav nav-tabs nav-justified bg-success" id="myTab" role="tablist" >
                            <li class="nav-item">
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                             ...
                             <select name="state" class="form-control" required="" >
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <button name="Patients_btn" type="submit" class="btnRegister bg-success" value="Register" style=" color: black; ">Submit</button>
                                    </div>
                                </form>
                                </div>
                            </div>
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-12">
                                      ...
                                      <option name="state" value="chandigarh " > Chandigarh  </option>
                                        ...
                                        <button type="submit" class="btnRegister bg-success" name="doc_apt_btn" value="Register" style="background-color: #E7717D; color: black;">Submit</button>
                                        </div>
                                        </div>
                                    </form>
                                    </div>
