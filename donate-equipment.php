...
<img src="img/bihar/donate.jpg" style="height: auto; width: 100%; margin-top: 10px; ">


<br><br>
<div class="container" >
  <div class="jumbotron" style="background-color: #f67280;" >    
   ...
   <a href="pmdonate.php"><button class="pm bg-primary"> Prime Minister National Releif Fund</button></a>
   
   <a href="http://www.cmrf.bih.nic.in/users/quickdonate.aspx"><button class="pm bg-primary">
   Chief Minister Releif Fund</button></a>

   <a href="orphan.php"><button class="pm bg-primary">Orphanage Donations</button></a>
